...
export default withMermaid(
  defineConfig({
    ...
    head: [
      [
        "link",
        { rel: "icon", href: "/dev-crew/dev-crew.png", type: "image/png" },
      ],
      [
        "link",
        {
          ...
          nav: [
            ...
            },
            {
              ...
              items: [
                {
                  text: "从零构建 Todo App",
                  link: "/examples/01-greenfield-todo-app",
                },
                {
                  text: "中途接入已有项目",
                  link: "/examples/02-midway-join-project",
                },
              ],
            },
          ],
      ...
      en: {
        ...
        themeConfig: {
          nav: [
            ...
            { text: "Learn More", link: "/en/concepts" },
          ],
          sidebar: [
            {
            ...
            },
            {
              ...
              items: [
                {
                  text: "Greenfield Todo App",
                  link: "/en/examples/01-greenfield-todo-app",
                },
                {
                  text: "Join Existing Project",
                  link: "/en/examples/02-midway-join-project",
                },
              ],
            },
          ],
    ...
    themeConfig: {
      ...
      footer: {
        ...
        copyright:
          'Built with <a href="https://github.com/lordmos/meridian">Meridian</a>',
      },
      search: {
        provider: "local",
      },
